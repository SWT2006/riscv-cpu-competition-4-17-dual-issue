...
VL_ATTR_COLD void Vtb_verilator_bench___024root___stl_sequent__TOP__0(Vtb_verilator_bench___024root* vlSelf);
...
VL_ATTR_COLD void Vtb_verilator_bench___024root___eval_stl(Vtb_verilator_bench___024root* vlSelf) {
    ...
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        Vtb_verilator_bench___024root___stl_sequent__TOP__0(vlSelf);
    }
}

VL_ATTR_COLD void Vtb_verilator_bench___024root___stl_sequent__TOP__0(Vtb_verilator_bench___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_verilator_bench___024root___stl_sequent__TOP__0\n"); );
    Vtb_verilator_bench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void Vtb_verilator_bench___024root___dump_triggers__act(Vtb_verilator_bench___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge tb_verilator_bench.clk)\n");
    }
    if ((2ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(negedge tb_verilator_bench.clk)\n");
    }
...
VL_ATTR_COLD void Vtb_verilator_bench___024root___dump_triggers__nba(Vtb_verilator_bench___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge tb_verilator_bench.clk)\n");
    }
    if ((2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(negedge tb_verilator_bench.clk)\n");
    }
...
VL_ATTR_COLD void Vtb_verilator_bench___024root___ctor_var_reset(Vtb_verilator_bench___024root* vlSelf) {
    ...
    vlSelf->tb_verilator_bench__DOT__u_soc__DOT__perip_mask = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 14799036692466468163ull);
    vlSelf->tb_verilator_bench__DOT__u_soc__DOT__perip_wdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 8821854565242777227ull);
    ...
    vlSelf->tb_verilator_bench__DOT__u_soc__DOT__u_cpu__DOT__u_ex__DOT__fwd_b2 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 331215464045424131ull);
