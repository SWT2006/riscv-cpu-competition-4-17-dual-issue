...
VL_INLINE_OPT VlCoroutine Vtb_verilator_bench___024root___eval_initial__TOP__Vtiming__1(Vtb_verilator_bench___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_verilator_bench___024root___eval_initial__TOP__Vtiming__1\n"); );
    ...
    while (VL_LIKELY(!vlSymsp->_vm_contextp__->gotFinish())) {
        co_await vlSelfRef.__VdlySched.delay(0x1388ULL, 
                                             ...
                                             21);
        vlSelfRef.tb_verilator_bench__DOT__clk = (1U 
                                                  & (~ (IData)(vlSelfRef.tb_verilator_bench__DOT__clk)));
    }
}
