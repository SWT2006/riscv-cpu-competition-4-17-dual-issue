...
//============================================================
// Events and timing
bool Vtb_verilator_bench::eventsPending() { return !vlSymsp->TOP.__VdlySched.empty(); }

uint64_t Vtb_verilator_bench::nextTimeSlot() { return vlSymsp->TOP.__VdlySched.nextTimeSlot(); }
